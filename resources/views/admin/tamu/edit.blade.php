...
@section('content')
  <section class="content">
    <div class="container-fluid">
      <div class="card">
        <div class="card-body">
          <form action="{{ route('admin.tamu.update', $guest->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                <input type="text" id="name" name="name"
                  ...
                  placeholder="Masukkan Nama" value="{{ old('name', $guest->name) }}" />
                @error('name')
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                <input type="text" id="origin"
                  ...
                  value="{{ old('origin', $guest->origin) }}" autocomplete="off" placeholder="Masukkan Asal" />
                @error('origin')
                  <small class="text-danger">{{ $message }}</small>
                @enderror
              </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                <input type="text" inputmode="numeric" id="phone_number"
                  ...
                  name="phone_number" value="{{ old('phone_number', $guest->phone_number) }}"
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                <input type="email" id="email" name="email"
                  ...
                  placeholder="Masukkan Email" value="{{ old('email', $guest->email) }}" />
                @error('email')
                  <small class="text-danger">{{ $message }}</small>
                @enderror
              </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                <textarea id="objectives" name="objectives" class="form-control @error('objectives') is-invalid @enderror"
                  autocomplete="off" placeholder="Masukkan Tujuan/Kepentingan" rows="3">{{ old('objectives', $guest->objectives) }}</textarea>
                @error('objectives')
                  <small class="text-danger">{{ $message }}</small>
                @enderror
              </div>
            ...
            <div class="mt-3">
              <a class="btn btn-secondary" href="{{ route('admin.tamu') }}">
                Kembali
              </a>
