<div>
  ...
  <ul>
    ...
    <li>Tanggal Mulai Magang : {{ \Carbon\Carbon::parse($intern->start)->locale('id')->translatedFormat('d F Y') }}</li>
    <li>Tanggal Selesai Magang : {{ \Carbon\Carbon::parse($intern->end)->locale('id')->translatedFormat('d F Y') }}</li>
